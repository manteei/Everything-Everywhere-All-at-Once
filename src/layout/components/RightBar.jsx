...
import {setRightGirl} from "../../service/reducer/actions";
    ...
    return (
        <div className={classes.girlStation}>
            <div style={{display: "flex", justifyContent: 'center', alignItems: "center", height: 70}}>
                <IconButton
                    onClick={() => handleUpLeft(props.indexAnimeRight, arrAnime, props.setRightGirl)}><KeyboardArrowUpIcon
                    fontSize={"large"}/></IconButton>
            </div>
            <div
                style={{display: "flex", justifyContent: 'center', alignItems: "center", height: "calc(100% - 140px)"}}>
                <img style={{height: "60%"}} src={arrAnime[props.indexAnimeRight]}/>
            </div>
            <div style={{display: "flex", justifyContent: 'center', alignItems: "center", height: 70}}>
                <IconButton
                    onClick={() => handleDownLeft(props.indexAnimeRight, arrAnime, props.setRightGirl)}><KeyboardArrowDownIcon
                    fontSize={"large"}/></IconButton>
            </div>
        </div>
    );
